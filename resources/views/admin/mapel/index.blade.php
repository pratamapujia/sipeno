    ...
    <section class="section">
      <div class="card">
        <div class="card-header">
          <a href="{{ route('mapel.create') }}" class="btn icon icon-left btn-primary">
            ...
            <tbody>
              @foreach ($mapel as $data)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('mapel.edit', Hashids::encode($data->id)) }}" class="btn icon icon-left btn-sm btn-warning">
                      <i class="fas fa-pencil"></i> Edit
                    </a>
                    <form action="{{ route('mapel.destroy', $data->id) }}" method="POST" class="d-inline">
                      @csrf
                      @method('DELETE')
