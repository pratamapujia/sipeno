...
@section('main')
          ...
          <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="{{ route('admin.m.kelas.index') }}">Master Mapel</a>
              </li>
  ...
  <div class="page-content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('admin.m.kelas.update', $kelas->id) }}" class="form" method="POST">
          @csrf
          @method('PUT')
          <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_kelas') is-invalid @enderror" name="nama_kelas" placeholder="Masukkan Nama Kelas" value="{{ old('kelas', $kelas->nama_kelas) }}">
                @error('nama_kelas')
            ...
            <div class="col-sm-12 col-md-4">
              <div class="form-group">
                ...
                <input type="number" class="form-control @error('tingkat') is-invalid @enderror" name="tingkat" placeholder="Masukkan Tingkat" value="{{ old('tingkat', $kelas->tingkat) }}">
                @error('tingkat')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
