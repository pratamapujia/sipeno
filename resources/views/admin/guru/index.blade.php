          ...
          <div class="modal-body">
            <div class="alert border border-success text-sm">
              ...
              <ol class="mb-0 ps-3 text-black">
                <li>Header baris pertama wajib: <b>nama_guru</b>, <b>email</b>, <b>jenis_kelamin</b>, <b>status</b></li>
                <li>Kolom <b>email</b> digunakan untuk membuat akun guru. Kolom email <b>Wajib Diisi</b></li>
